...
exports.alertChannelConfig = exports.logRetentionConfig = exports.defaultLogPatterns = void 0;
/**
 * Padrões de monitoramento predefinidos para o sistema de logs
 */
exports.defaultLogPatterns = [
    {
        id: 'critical-errors',
