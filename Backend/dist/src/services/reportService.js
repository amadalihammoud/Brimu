...
exports.generateBusinessReport = generateBusinessReport;
...
exports.generateEquipmentReport = generateEquipmentReport;
...
async function generateBusinessReport(options) {
    try {
        ...
        logger_1.logger.error('Error generating business report', error);
        throw error;
    }
}
...
async function generateOperationalReport(options) {
    try {
        const mockData = {
            productivity: {
                servicesPerDay: 2.3,
...
async function generateEquipmentReport(options) {
    try {
        const mockData = {
            inventory: [
                {
...
async function exportReportToPDF(options) {
    try {
...
function generateMonthlyData(dateRange) {
...
function generateCashFlowData(dateRange) {
    return [
