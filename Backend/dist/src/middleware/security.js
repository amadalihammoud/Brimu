...
exports.generateCSRFToken = exports.deviceFingerprintMiddleware = exports.authenticateWithCookie = exports.secureTokenMiddleware = exports.csrfProtectionMiddleware = exports.monitorLoginAttempts = exports.default = void 0;
...
const csrfProtectionMiddleware = (req, res, next) => {
    ...
    if (['POST', 'PUT', 'PATCH', 'DELETE'].includes(method)) {
        ...
        if (!cookieToken || !clientToken || cookieToken !== clientToken) {
            logger_1.logger.warn('CSRF token mismatch', {
                ip: req.ip,
                path: req.path,
...
const secureTokenMiddleware = (req, res, next) => {
...
exports.secureTokenMiddleware = secureTokenMiddleware;
...
const deviceFingerprintMiddleware = (req, res, next) => {
    ...
    if (isSuspicious) {
        logger_1.logger.warn('Suspicious device detected', {
            ip: req.ip,
            userAgent: userAgent,
...
const monitorLoginAttempts = (req, res, next) => {
    ...
    res.send = function (data) {
        ...
        logger_1.logger.info('Login result', {
            ip: ip,
            email: email,
            success: isSuccess,
